...
public:
	...
	virtual const ViewMatrix& WorldToScreenMatrix() = 0;
	...
	virtual const ViewMatrix& WorldToViewMatrix() = 0;
	...
	virtual void		DebugDrawPhysCollide(const void* pCollide, void* pMaterial, void* transform, const Vector& color) = 0;
